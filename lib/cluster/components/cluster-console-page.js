...
function RoleHeaderButton({ roleId, roleName, running, max, clusterId }) {
  ...
  const handleRun = async (e) => {
    ...
    try {
      ...
      if (result?.concurrencyExceeded) {
        setRateLimited(true);
        setTimeout(() => setRateLimited(false), 2e3);
      }
    } catch {
    }
    setTriggering(false);
  ...
  let playIcon;
  if (triggering) {
    playIcon = /* @__PURE__ */ jsxs("svg", { className: "animate-spin h-3.5 w-3.5", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [
      /* @__PURE__ */ jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }),
      /* @__PURE__ */ jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" })
    ] });
  } else if (rateLimited) {
    playIcon = /* @__PURE__ */ jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", fill: "currentColor", className: "h-3.5 w-3.5 text-orange-500", children: /* @__PURE__ */ jsx("path", { d: "M6.25 4.75l5.5 3.25-5.5 3.25V4.75z" }) });
  } else {
    playIcon = /* @__PURE__ */ jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", fill: "currentColor", className: "h-3.5 w-3.5", children: /* @__PURE__ */ jsx("path", { d: "M6.25 4.75l5.5 3.25-5.5 3.25V4.75z" }) });
  }
  return /* @__PURE__ */ jsxs(
    "button",
    {
      onClick: handleRun,
      disabled: triggering,
      className: `inline-flex items-center rounded-full px-3 py-1 text-xs transition-colors disabled:opacity-40 ${running > 0 ? "bg-green-500/20 text-green-600 dark:text-green-400 hover:bg-green-500/30" : "bg-muted/50 text-muted-foreground hover:bg-muted"}`,
      children: [
    ...
    /* @__PURE__ */ jsxs("tbody", { children: [
      containers.map((c) => {
        ...
        return /* @__PURE__ */ jsxs("tr", { className: "border-b border-border last:border-0", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "text-right px-3 py-1", children: c.running ? /* @__PURE__ */ jsx("span", { className: "text-green-600 dark:text-green-400", children: "RUN" }) : /* @__PURE__ */ jsx("span", { className: "text-muted-foreground/60", children: "STOP" }) })
        ] }, c.name);
      }),
