...
function WorkerTile({ worker, stats, logs, logVersion, roles }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col rounded-lg border border-border bg-card overflow-hidden min-h-0", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-2 font-mono text-xs min-h-0 bg-background/50", children: [
      logs.length === 0 ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-full text-muted-foreground text-xs", children: isRunning ? "Waiting for output..." : "No active session" }) : mode === "console" ? /* @__PURE__ */ jsx("div", { className: "space-y-0", children: logs.map((entry, i) => /* @__PURE__ */ jsx("div", { className: "text-muted-foreground whitespace-pre-wrap break-all leading-relaxed", children: entry.raw }, i)) }) : /* @__PURE__ */ jsx(ClaudeLogView, { logs, expandedTools, toggleTool }),
...
function StatsPanel({ workers, stats, roles }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "shrink-0 border-t border-border bg-zinc-950 text-zinc-300 font-mono text-xs overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-zinc-800 text-zinc-500", children: [
    ...
    /* @__PURE__ */ jsxs("tbody", { children: [
      workers.map((w) => {
        ...
        return /* @__PURE__ */ jsxs("tr", { className: "border-b border-zinc-900 last:border-0", children: [
          /* @__PURE__ */ jsxs("td", { className: "px-3 py-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-zinc-500", children: shortId(w) }),
            " ",
            /* @__PURE__ */ jsx("span", { children: w.name || "Worker" }),
            roleName && /* @__PURE__ */ jsxs("span", { className: "text-zinc-600 ml-1", children: [
              "(",
              roleName,
              ")"
            ] })
          ...
          /* @__PURE__ */ jsx("td", { className: "text-right px-3 py-1", children: isRunning ? /* @__PURE__ */ jsx("span", { className: "text-green-400", children: "RUN" }) : /* @__PURE__ */ jsx("span", { className: "text-zinc-600", children: "STOP" }) })
        ] }, w.id);
      }),
      /* @__PURE__ */ jsxs("tr", { className: "border-t border-zinc-700 text-zinc-400 font-medium", children: [
