...
function ClusterPage({ session, clusterId, roleId }) {
  ...
  return /* @__PURE__ */ jsxs(PageLayout, { session, children: [
    ...
    activeTab === "general" ? /* @__PURE__ */ jsxs("div", { children: [
      ...
      (!cluster.roles || cluster.roles.length === 0) && /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-dashed border-border p-8 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-3", children: "No roles yet. Add a role to this cluster." }),
        /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: handleAddRole,
