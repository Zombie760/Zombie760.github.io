      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium border transition-colors ${hasWebhook ? "bg-foreground text-background border-foreground" : "bg-background text-muted-foreground border-input hover:border-foreground/50"}`,
            children: "Webhook"
          }
        )
      ] })
    ] }),
    (hasCron || hasFileWatch || hasWebhook) && /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-col gap-3", children: [
