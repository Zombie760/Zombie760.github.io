...
function ClustersPage() {
  ...
  const handleStar = async (clusterId) => {
    setClusters(
      (prev) => prev.map((c) => c.id === clusterId ? { ...c, starred: c.starred ? 0 : 1 } : c)
    );
  ...
  const handleRename = async (clusterId, name) => {
    setClusters(
      (prev) => prev.map((c) => c.id === clusterId ? { ...c, name } : c)
    );
      ...
      "a",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            ) : /* @__PURE__ */ jsx("span", { className: "text-sm truncate block", children: cluster.name || "New Cluster" }),
            /* @__PURE__ */ jsxs("span", { className: "text-xs text-muted-foreground", children: [
              "Updated ",
              timeAgo(cluster.updatedAt)
            ] })
          ] }),
          !editing && /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex items-center gap-1", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
